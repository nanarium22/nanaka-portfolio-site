  ...
  return (
    <div className="container mx-auto p-8">
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-extrabold text-gray-800">山田 太郎</h1>
      ...
      <section className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-xl mb-12">
        ...
        <p className="text-gray-600 leading-relaxed">
          ご覧いただきありがとうございます。主にReactを用いたフロントエンド開発を中心に活動しています。
          ユーザーフレンドリーで**パフォーマンスの高い**ウェブサイト開発を目標に、日々新しい技術を学んでいます。
